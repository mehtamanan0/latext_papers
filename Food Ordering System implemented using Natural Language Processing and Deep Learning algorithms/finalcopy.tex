...
\begin{document}
	...
	\author{\IEEEauthorblockN{Anmol R.Sajnani,}
		\IEEEauthorblockA{Computer Engineering, B.Tech(Intg)\\MPSTME, NMIMS\\Mumbai, India\\anmolsajnani04@gmail.com}
		\and
		\IEEEauthorblockN{Hitesh M.Jeswani,}
		\IEEEauthorblockA{Computer Engineering, B.Tech(Intg)\\MPSTME, NMIMS\\Mumbai, India\\hiteshjeswani112@gmail.com}
		\and
		\IEEEauthorblockN{Manan R.Mehta,}
		\IEEEauthorblockA{Computer Engineering, B.Tech(Intg)\\MPSTME, NMIMS\\Mumbai, India\\mehtamanan0@gmail.com}
	}
	\maketitle
...
\end{itemize}
	...
	\begin{thebibliography}{00}
		...
		NIPS.
		\bibitem{b6} Lokesh Kumar, Dr. Shalini Rajawat, and Krati Joshi, "Comparative analysis of NoSQL (MongoDB) with MySQL Database", \textit{International Journal of Modern Trends in Engineering and Research}
		\bibitem{b7}Eril Cambria, Soujanya Poria, Alexander Gelbukh, and Mike Thelwall, “Sentiment Analysis Is a Big Suitcase”, IEEE 2017
		\bibitem{b8} R. Jenitha Sri and P. Ajitha, "Survey of Product Reviews using Sentiment Analysis", \textit{International Journal of Science and Technology}
		\bibitem{b9} Anuja P.Jain and Asst. Prof Padma Dandannavar, "Application of Machine Learning Techniques to Sentiment Analysis", IEEE 2016
		\bibitem{b10}BiswaRanjanSamal, Anil Kumar Behera, and Mrutyunjaya Panda, “Performance Analysis of Supervised Machine Learning Techniques for Sentiment Analysis”, IEEE 3rd International Conference on Sensing, Signal Processing and Security(ICSSS)
		\bibitem{b11}  Sneha Lukose and Savitha S. Upadhya,"Text to Speech Synthesizer-Formant Synthesis", International Conference on Nascent Technologies in the Engineering Field, IEEE 2017 (2018, April 21) 
		...
		\bibitem{b14}Kyunghyun Cho, Bart van Merrienboer, Caglar Gulcehre, Dzmitry Bahdanau, Fethi Bougares, Holger Schwenk, Yoshua Bengio,
